FAMILY  = artix7
PART    = $(strip xc7a50tfgg484-1)
#pode experimentar -2 -2L e -3 ainda. Encontrado em /snap/openxc7/current/opt/nextpnr-xilinx/external/prjxray-db/artix7/xc7a50tfgg484*
BOARD   = colorlight-i9+
PROJECT = pll250
...
${PROJECT}.bit: ${PROJECT}.frames
	...
	sudo openFPGALoader -c ch347_jtag -b $(BOARD) $(PROJECT).bit
